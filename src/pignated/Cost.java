    ...
    Cost() {
        ...
        if(GeneralUse.getYN()) {
            ...
            if(GeneralUse.getYN()) {
                ...
                cmc += white + blue + black + red + green;
            }
            ...
            if(GeneralUse.getYN()){
                ...
                cmc += whiteBlue + whiteBlack + blueBlack + blueRed
                        + blackRed + blackGreen + redGreen + redWhite + greenWhite + greenBlue
                        +2*(colorlessWhite + colorlessBlue +
                        colorlessBlack + colorlessRed + colorlessGreen);
            }
